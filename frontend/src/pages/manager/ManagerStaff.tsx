...
export const ManagerStaff: React.FC = () => {
  ...
  useEffect(() => {
    setPageTitle({ title: 'Staff', subtitle: 'Manage the team below you' });
  ...
  const toggleActiveStatus = useCallback(async (user: User, nextActive: boolean) => {
    ...
    addToast({
      ...
      message: nextActive ? 'They can now log in again.' : 'They will no longer be able to log in.',
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-end gap-1">
                          {manageable ? (
                            ...
                            <Tooltip label="You can't modify another manager — ask the owner.">
